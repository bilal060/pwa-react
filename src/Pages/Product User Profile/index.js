    ...
    return (
        <div className='product-user-profile'>
            <div className='container mx-auto'>
                <div className='d-sm-flex d-none align-items-center gap-2 font-18-100 font-weight-500 mb-4'>
                ...
                <div className='row m-0'>
                    <div className='col-xl-9 col-lg-8 ps-0 pe-xl-3 pe-0 mb-md-0 pb-lg-0 mb-4 pb-3'>
                    ...
                    <div className='col-xl-3 col-lg-4 pe-0 ps-md-3 ps-0'>
                        <div className='seed-card flex-column'>
                            ...
                            <span className='d-flex gap-2 align-items-center font-18 font-weight-500 mb-4 pb-1'>
                                <LocationIcon />
                                <span>789 Yonge St, Toronto, ON M4W 2G8, Canada</span>
                            </span>
                            <button className='green-btn w-auto ps-3 pe-1 d-flex align-items-center justify-content-between font-18 py-sm-3 py-2 user'> <span>Message</span> <span className='send-message w-max-content'><SendMailIcon /></span></button>

                            {/* <button className='green-btn ps-3 pe-1 d-flex align-items-center justify-content-between font-18 py-sm-3 py-sm-2 gap-2'> <span>View Profile </span> <span className='send-message w-auto'><SendMailIcon /></span></button> */}
                        </div>

                    </div>
                </div>
                <div className='row m-0 pt-4'>
                    <div className='col-lg-3 col-md-6 ps-0 pe-md-3 pe-0 bg-transparent border-0 mb-3'>
                    ...
                    <div className='col-lg-3 col-md-6 pe-0 ps-md-3 ps-0 bg-transparent border-0'>
