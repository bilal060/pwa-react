                            ...
                            {seedData.map((data, index) => {
                                return (
                                    <div className='col-xl-6 mb-4 seed-card-col' key={index}>
                                        <div className='seed-card position-relative text-black flex-md-row justify-content-between gap-sm-4 ga-2'>
                                            <img className='w-xl-40 intro-img' src={data.img} alt='' />
                                            ...
                                            <div className='ps-sm-0 ps-3 w-100'>
                                                ...
                                                <div className='d-flex flex-sm-row flex-column justify-content-between align-items-center gap-sm-3 gap-2 mt-3 flex-wrap'>
                    ...
                    <div className="tab-pane fade" id="pills-cannabis" role="tabpanel" aria-labelledby="pills-cannabis-tab">
                        <div className='seeds-card-main row m-0'>
                            <div className='seeds-card-main row m-0'>
                                {seedData.map((data, index) => {
                                    return (
                                        <div className='col-md-6 mb-4 seed-card-col' key={index}>
                                            <div className='seed-card position-relative text-black flex-row gap-4'>
                                                <img className='w-50 intro-img' src={data.img} alt='' />
                                                <span className='like-post'>
                                                    <HeartIcon />
                                                </span>
                                                <div className='ps-sm-0 ps-3'>
                                                    <p className='mb-4 pb-3 font-24 font-weight-700'>{data.name}</p>
