...
const UserProfile = () => {
  ...
  useEffect(() => {
    ...
    const GetUserUrl = `${process.env.REACT_APP_API_URI}users/${data._id}?userType=${data.userType.toLowerCase()}`;
    GetUser(GetUserUrl);
  }, []);
  return (
        ...
        <div className="row m-0">
          <div className="col-xl-3 pe-md-0 col-md-6 mb-md-0 pb-lg-0 mb-4 pb-3">
            <div className="seed-card flex-column">
              ...
              <Link
                to={"/myaccount/edit"}
                className="green-btn-outline text-white bg-primary-green ps-3 pe-1 d-flex align-items-center justify-content-between font-18 py-sm-3 py-2 gap-2 mb-3"
              >
