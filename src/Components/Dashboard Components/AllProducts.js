...
const ShowAllProducts = () => {
  ...
  const GetAllProductUrl = `${process.env.REACT_APP_API_URI}users/getAllData/`;
            ...
            <div className="seed-card h-100 position-relative">
              ...
              <div className="ps-sm-0 ps-3">
                ...
                <div className="d-flex justify-content-between align-items-center gap-sm-2 gap-3 flex-sm-nowrap flex-wrap">
                  ...
                  <Link
                    to={"/chat"}
                    className="text-white green-btn w-auto ps-3 pe-1 d-flex align-items-center font-18 py-sm-3 gap-3"
                  >
                    {" "}
                    <span>Message</span>{" "}
