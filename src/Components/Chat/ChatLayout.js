...
const Chat = () => {
    ...
    return (
        <>
                        ...
                        {true &&
                            <div onClick={() => {
                                ...
                                <svg width={9} height={18} viewBox="0 0 9 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path fillRule="evenodd" clipRule="evenodd" d="M8.71025 0.29552C9.09658 0.689547 9.09658 1.32839 8.71025 1.72242L2.26012 8.30089C1.88471 8.68377 1.88471 9.31623 2.26012 9.69911L8.71025 16.2776C9.09658 16.6716 9.09658 17.3105 8.71025 17.7045C8.32391 18.0985 7.69753 18.0985 7.31119 17.7045L0.861065 11.126C-0.287021 9.95507 -0.287021 8.04493 0.861066 6.874L7.31119 0.29552C7.69753 -0.0985068 8.32391 -0.0985067 8.71025 0.29552Z" fill="#0F8140" />
                                </svg>
                            </div>
                        }
                        <DashboardLogo />
            ...
            <div className={`${!recentChats ? 'chat-screen-content' : 'chat-screen-content-footer'}`}>
                <div className={`${!recentChats ? 'h-100' : ''} chat-screen `}>
                    <div className={`${!recentChats ? 'h-100' : ''} container mx-auto px-12`}>
                        <div className={`${!recentChats ? 'h-100' : ''}`}>
                            <div className='row m-0 h-100'>
                                {recentChats && <div className='col-md-5 col-12 px-12'>
                                                    ...
                                                    return (
                                                        <>
                                                            <button
                                                                ...
                                                                aria-selected="true"
                                                            >
                                                                <div className='d-md-flex d-none align-items-center w-100 gap-2' type="button" >
                                                                ...
                                                                <div className='d-md-none d-flex align-items-center w-100 gap-2' type="button" onClick={() => {
                                                                    setResponsiveChat(true)
                                ...
                                {
                                    responsiveChat && <div className='col-md-7 col-12 px-12'>
                                        <div className='seed-card h-100 px-sm-4 px-4'>
                                            {chatsdetail.map((chatsdetail, index) => {
                                                return (
                                                    ...
                                                    >
                                                        <div className='d-flex align-items-center justify-content-enduser-name pb-4 mb-4 chat-detail-header pt-sm-0 pt-4' type="button">
                                                            <div onClick={() => {
                                                                setResponsiveChat(false)
                                                                setrecentChats(true)
                                                            }}
                                                            ...
                                                            <div className='w-100 d-flex flex-column justify-content-start align-items-start'>
                                                                ...
                                                                <div className='d-flex justify-content-start align-items-center gap-2'>
                                                                    <svg width="9" height="9" viewBox="0 0 9 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                        <circle cx="4.29825" cy="4.29825" r="4.29825" fill="#5D8B2F" />
                                                                    </svg>
                                                                    <p className='font-14 font-weight-400 text-grey'> Available</p>
                                                                </div>
